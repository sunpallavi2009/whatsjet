                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col">
                                    ...
                                    <span class="h2 font-weight-bold mb-0" x-text="campaignLog"></span>
                                </div>
                                <div class="col-auto">
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col">
                                    ...
                                    <span class="h2 font-weight-bold mb-0" x-text="totalLogDeliveredInPercent"></span>
                                </div>
                                <div class="col-auto">
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col">
                                    ...
                                    <span class="h2 font-weight-bold mb-0" x-text="totalLogReadInPercent"></span>
                                </div>
                                <div class="col-auto">
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col">
                                    ...
                                    <span class="h2 font-weight-bold mb-0" x-text="__Utils.formatAsLocaleNumber(totalLogFailedInPercent)"></span>
                                </div>
                                <div class="col-auto">
...
$campaignLog = $messageLog->where('campaigns__id', $campaignLogId)->count();
// Ensure $campaignLog is not zero before proceeding
$totalLogReadInPercent = $campaignLog != 0 ? round($totalRead / $campaignLog * 100, 2) . '%' : '0%';
$totalLogDeliveredInPercent = $campaignLog != 0 ? round(($totalDelivered + $totalRead) / $campaignLog * 100, 2) . '%' : '0%';
$totalLogFailedInPercent = $campaignLog != 0 ? round($totalFailed / $campaignLog * 100, 2) . '%' : '0%';


$totalReadInPercent = round($totalRead / $campaignLog * 100, 2) . '%';
$totalDeliveredInPercent = round(($totalDelivered + $totalRead) / $campaignLog * 100, 2) . '%';
$totalFailedInPercent = round($totalFailed / $campaignLog * 100, 2) . '%';
...
<script>
    ...
    document.addEventListener('alpine:init', () => {
        Alpine.data('initialRequiredData', () => ({
            ...
            totalLogDeliveredInPercent: '{{ $totalLogDeliveredInPercent }}',
            totalDelivered: '{{ $totalDelivered }}',
            totalRead: '{{ $totalRead }}',
            totalLogReadInPercent: '{{ $totalLogReadInPercent }}',
            totalFailed: '{{ $totalFailed }}',
            totalLogFailedInPercent: '{{ $totalLogFailedInPercent }}',

<x-lw.modal id="lwEditContact" :header="__tr('Edit Contact')" :hasForm="true">
    ...
    <x-lw.form id="lwEditContactForm" :action="route('vendor.contact.write.update')"
        ...
        <!-- /Country -->
        <!-- Phone_Number -->
       <x-lw.input-field class="disabled" disabled type="text" id="lwPhoneNumberEditField"  minlength="9" data-form-group-class="" :label="__tr('Phone Number')" value="<%- __tData.wa_id %>" name="phone_number"  />
        <!-- /Phone_Number -->
        <!-- Language Code -->
